...
// GWAS_score_test_AG_bed_float_TEST
...
RcppExport SEXP _scottage_GWAS_score_test_AG_bed_float_TEST(SEXP pASEXP, SEXP pSEXP, SEXP timesSEXP, SEXP begSEXP, SEXP endSEXP, SEXP nmSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< XPtr<matrix4> >::type pA(pASEXP);
    ...
    Rcpp::traits::input_parameter< int >::type end(endSEXP);
    Rcpp::traits::input_parameter< Rcpp::XPtr<nullObject<float>> >::type nm(nmSEXP);
    rcpp_result_gen = Rcpp::wrap(GWAS_score_test_AG_bed_float_TEST(pA, p, times, beg, end, nm));
    return rcpp_result_gen;
END_RCPP
}
// GWAS_score_test_AG_bed_double_TEST
...
RcppExport SEXP _scottage_GWAS_score_test_AG_bed_double_TEST(SEXP pASEXP, SEXP pSEXP, SEXP timesSEXP, SEXP begSEXP, SEXP endSEXP, SEXP nmSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< XPtr<matrix4> >::type pA(pASEXP);
    ...
    Rcpp::traits::input_parameter< int >::type end(endSEXP);
    Rcpp::traits::input_parameter< Rcpp::XPtr<nullObject<double>> >::type nm(nmSEXP);
    rcpp_result_gen = Rcpp::wrap(GWAS_score_test_AG_bed_double_TEST(pA, p, times, beg, end, nm));
    return rcpp_result_gen;
END_RCPP
}
// mk_nullObject_float
...
// score_test_float_TEST
float score_test_float_TEST(Rcpp::XPtr<nullObject<float>> nm, Rcpp::NumericVector X);
RcppExport SEXP _scottage_score_test_float_TEST(SEXP nmSEXP, SEXP XSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::XPtr<nullObject<float>> >::type nm(nmSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type X(XSEXP);
    rcpp_result_gen = Rcpp::wrap(score_test_float_TEST(nm, X));
    return rcpp_result_gen;
END_RCPP
}
// score_test_double_TEST
double score_test_double_TEST(Rcpp::XPtr<nullObject<double>> nm, Rcpp::NumericVector X);
RcppExport SEXP _scottage_score_test_double_TEST(SEXP nmSEXP, SEXP XSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::XPtr<nullObject<double>> >::type nm(nmSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type X(XSEXP);
    rcpp_result_gen = Rcpp::wrap(score_test_double_TEST(nm, X));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_scottage_GWAS_score_test_AG_bed_float_TEST", (DL_FUNC) &_scottage_GWAS_score_test_AG_bed_float_TEST, 6},
    {"_scottage_GWAS_score_test_AG_bed_double_TEST", (DL_FUNC) &_scottage_GWAS_score_test_AG_bed_double_TEST, 6},
    ...
    {"_scottage_score_test_float_TEST", (DL_FUNC) &_scottage_score_test_float_TEST, 2},
    {"_scottage_score_test_double_TEST", (DL_FUNC) &_scottage_score_test_double_TEST, 2},
    {NULL, NULL, 0}
};
